...
| `packages/protocol`          | Portable versioned snapshots, messages and payloads; the one owner of every shared vocabulary (sides, roles, error codes, topic families, presence and delivery statuses)                                                                                                                                                                                                                                        | zod                                                                                                              | @2witstudios |
...
| `packages/errors`            | The public/internal error mapping for the protocol's error codes                                                                                                                                                                                                                                                                                                                                                 | protocol                                                                                                         | @2witstudios |
